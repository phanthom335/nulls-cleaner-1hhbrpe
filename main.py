        """
        Nulls Cleaner 1hhbrpe
        =====================
        Lightweight ETL component that can enrich millions of rows efficiently.
...
from pathlib import Path
        ...
        APP_NAME    = "Nulls Cleaner 1hhbrpe"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight ETL component that can enrich millions of rows efficiently.")
